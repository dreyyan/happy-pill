...
return (
	<div className="min-h-screen flex flex-col px-[32px] py-[80px]">
        ...
        <div className="space-y-10 [&_img]:mt-8 [&_img]:mb-6">
            <>
                <img src="" className="mb-4 flex flex-col items-center mt-10"></img>
                <p className="caption italic">Your Daily Dose of Happiness in Iloilo City – Est. 2024</p>
            </>

            {/* OUR STORY */}
            <>
                <div className="mx-6">
                    <h3 className="text-xl font-bold mt-4">Our Story</h3>
                    <img src="gallery/venue/7.jpg" alt="" className="w-full h-auto mt-8 mb-6" />
            ...
            <>
                <div className="mx-6">
                    <h3 className="text-xl font-bold mt-4">The Venue</h3>
                    <img src="gallery/venue/2.jpg" alt="" className="w-full h-auto" />
                    <p className="mt-2 caption">
            ...
            <>
                <div className="mx-6">
                    <h3 className="text-xl font-bold mt-4">Our Team</h3>
                    <img src="gallery/christmas_new_year/5.jpg" alt="" className="w-full h-auto" />
                    <p className="mt-2 caption">
